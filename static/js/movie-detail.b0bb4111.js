...
* Copyright (c) 2016 Sachin N; Licensed Apache 2.0 */
        !function (t, i, e, s) {
            ...
            n.prototype.init = function () {
                ...
                s.core.$outer.addClass("lg-has-thumb"), s.core.$outer.find(".lg").append('<div class="lg-thumb-outer"><div class="lg-thumb group"></div></div>'), s.$thumbOuter = s.core.$outer.find(".lg-thumb-outer"), s.thumbOuterWidth = s.$thumbOuter.width(), s.core.s.animateThumb && s.core.$outer.find(".lg-thumb").css({
                ...
                var i = this.core.s.thumbWidth + this.core.s.thumbMargin, e = t + this.thumbOuterWidth / 2,
                    s = Math.floor(e / i), o = this.dynamicGetThumb(s), n = i * o, a = t - n;
                ...
                e.$thumbOuter.addClass("lg-grab"), e.core.$outer.find(".lg-thumb").on("mousedown.lg.thumb", function (t) {
                    ...
                    if (n) {
                        ...
                        r -= o - s, r > e.thumbTotalWidth - e.thumbOuterWidth && (r = e.thumbTotalWidth - e.thumbOuterWidth), r < 0 && (r = 0);
                        var i = e.core.$outer.find(".lg-thumb");
                        e.core.lGalleryOn ? (i.hasClass("on") || i.css("transition-duration", e.core.s.speed + "ms"), e.core.doCss() || i.animate({left: -e.left + "px"}, e.core.s.speed)) : e.core.doCss() || i.css("left", -e.left + "px"), e.setTranslate(r)
                    }
        ...
        function jBox(type, options) {
            ...
            return this.IE8 = -1 != userAgent.indexOf("msie") && 8 == parseInt(userAgent.split("msie")[1]), this.prefix = -1 != userAgent.indexOf("webkit") ? "-webkit-" : "", this._getOpp = function (t) {
                ...
                if (a || r) {
                    ...
                    var h = "x" == this._getXY(this.outside) ? r : a;
                    if (this.pointer && "flip" != this.options.adjustPosition && this._getXY(h) == this._getOpp(this._getXY(this.outside))) {
                        if ("center" == this.pointer.align) var l = this.dimensions[this._getXY(h)] / 2 - this.pointer.dimensions[this._getOpp(this.pointer.xy)] / 2 - parseInt(this.pointer.element.css("margin-" + this.pointer.alignAttribute)) * (h != this._getTL(h) ? -1 : 1); else var l = h == this.pointer.alignAttribute ? parseInt(this.pointer.element.css("margin-" + this.pointer.alignAttribute)) : this.dimensions[this._getXY(h)] - parseInt(this.pointer.element.css("margin-" + this.pointer.alignAttribute)) - this.pointer.dimensions[this._getXY(h)];
                        spaceDiff = h == this._getTL(h) ? i[this._getTL(h)] - this.pos[this._getTL(h)] + this.options.adjustDistance[h] : -1 * (i[this._getOpp(this._getTL(h))] - this.pos[this._getTL(h)] - this.options.adjustDistance[h] - this.dimensions[this._getXY(h)]), h == this._getOpp(this._getTL(h)) && this.pos[this._getTL(h)] - spaceDiff < i[this._getTL(h)] + this.options.adjustDistance[this._getTL(h)] && (spaceDiff -= i[this._getTL(h)] + this.options.adjustDistance[this._getTL(h)] - (this.pos[this._getTL(h)] - spaceDiff)), spaceDiff = Math.min(spaceDiff, l), spaceDiff <= l && spaceDiff > 0 && (this.pointer.element.css("margin-" + this.pointer.alignAttribute, parseInt(this.pointer.element.css("margin-" + this.pointer.alignAttribute)) - spaceDiff * (h != this.pointer.alignAttribute ? -1 : 1)), this.wrapper.css(this._getTL(h), this.pos[this._getTL(h)] + spaceDiff * (h != this._getTL(h) ? -1 : 1)), this.positionAdjusted = !0)
                    }
                }
        ...
        function n(t, i, e) {
            return null == t ? t : (t = t.replace(/^http:/, "https:"), t = t.replace("/w.h/", "/"), t = t.split("@")[0], i && e && (t = t + "@" + i + "w_" + e + "h_1e_1c"), t)
        }

        function a() {
            w.data("score") ? (T.text("看过"), w.addClass("active")) : w.data("wish") ? (T.text("已想看"), w.addClass("active")) : (T.text("想看"), w.removeClass("active"))
        }

        function r() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : system.myComment, i = t.score,
                e = void 0 === i ? 0 : i, s = t.content, n = void 0 === s ? "" : s;
            e ? (j.addClass("active"), C.text(2 * e + "分，" + o(2 * e)), w.addClass("active").data("score", e).data("wish", !1), T.text("看过")) : (j.removeClass("active"), C.text("评分"), w.data("score", 0)), a(), n ? B.text("我的短评") : B.text("写短评")
        }

        function h() {
            var t = $(".comment-list-container");
            t.data("hot") || $.get("/ajax/proxy/mmdb/comments/movie/" + x + ".json", {token: system.user && system.user.token}).then(function (i) {
                i && !i.error && t.html(f.render({commentList: (i.cmts || []).slice(0, 10)}))
            })
        }

        function l(t) {
            S && $(this).on("click", function () {
                0 == D.length - 1 && function t() {
                    0 === $(".lg-outer .lg-img-wrap").length ? setTimeout(t, 50) : $(".lg-outer .lg-img-wrap").addClass("thumb-one")
                }(), $(this).lightGallery($.extend({}, S, {index: t})).on("onAfterOpen.lg", m.disableScroll).on("onCloseAfter.lg", m.enableScroll)
            })
        }

        e(1258), e(1023);
        var d = e(212), p = e(397), u = e(399), c = function (t) {
            return t && t.__esModule ? t : {default: t}
        }(u), m = e(395), g = e(397);
        e(393), e(394), e(1016), e(1012);
        var f = e(1259), b = $(document), y = $(window), v = e(1024),
            x = system.movieId || location.pathname.split("/").pop(), j = $(".action .score-btn"),
            C = j.find(".score-btn-msg"), w = $(".action .wish"), T = w.find(".wish-msg"), B = $(".comment-entry"),
            _ = function () {
                ...
                return function (i, e) {
                    ...
                    return s = e ? $.ajax({
                        method: "PUT",
                        url: (0, g.utmParam)("/ajax/proxy/mmdb/comment/" + x + "/" + e + ".json"),
                        data: $.extend({business: 1, clientType: "web"}, t, i),
                        dataType: "json"
                    }) : $.post((0, g.utmParam)("/ajax/proxy/mmdb/comments/movie/" + x + ".json"), $.extend({
                        business: 1,
                        clientType: "web"
                    }, t, i)), s.then(function (t) {
                        return t.error || ($.extend(system.myComment, i), r()), t
                    })
                }
            }();
        $(".movie-live").click((0, p.noRepeatRequest)(function (t) {
            var i = this, e = window.open("about:blank", "_blank");
            return $.get("/ajax/proxy/mmdb/movie/web/online/play/" + x + ".json").then(function (t) {
                i.isLoading = !1, t.error && e.close(), t.data && t.data.link ? e.location.href = t.data.link : e.close()
            }).fail(function () {
                e.close()
            })
        })), w.on("click", (0, d.checkLogin)((0, p.noRepeatRequest)(function (t) {
            var i = $(this);
            if (i.data("score")) return _({score: 0, content: ""}, system.myComment.id).then(function (t) {
                t.error || (h(), j.data("jBoxWidget").commentForm.scoreStarWidget.enable())
            });
            var e = i.data("wish") ? "delete" : "post";
            return $.ajax({url: "/ajax/movie/" + x + "/wish", method: e, dataType: "json"}).then(function (t) {
                !1 === t.hasLogin ? (0, d.login)() : t.error || (i.data("wish", "post" === e), a())
            })
        })));
        var k = $(".tab-container").tab().data("tab");
        $(".tab-content-container").on("click", ".more", function (t) {
            var i = $(this).attr("href").slice(1), e = $(".tab-" + i);
            return k.active(e), b.scrollTop(420), !1
        }), k.$elem.on("change", function () {
            y.trigger("loadImg")
        });
        var O = function () {
            function t(i) {
            ...
            return t.prototype.bindEvents = function () {
                ...
                this.$elem.on("submit", function (i) {
                    if (i.preventDefault(), !t.$submitBtn.hasClass("disabled")) {
                        ...
                        _(e, t.commentData.id).then(function (i) {
                            i.error || (t.$elem.trigger("submit-success", t.commentData), h(), system.user.isProfessional && t.scoreStarWidget.disable())
                        })
                    }
                ...
                var t = this;
                $.get("/ajax/movie/" + x + "/comment").then(function (i) {
        ...
        B.on("click", function () {
            j.trigger("click")
        }), j.on("click", (0, d.checkLogin)(function () {
            ...
            i || (i = new v("Modal", {
                ...
                onOpen: function () {
                    ...
                    var i = this;
                    this.commentForm = new O(this.content.find("#comment-form")), this.commentForm.$elem.on("submit-success", function (t, e) {
                        i.close()
                ...
                onClose: function () {
                    this.commentForm.reset(), (0, m.enableScroll)()
                }
            }), t.data("jBoxWidget", i)), i.open()
        })), $(".comment-list-container").on("click", ".approve-icon", (0, d.checkLogin)((0, p.noRepeatRequest)(function (t) {
            var i = $(this).closest(".approve"), e = i.data("id");
            return $.post((0, g.utmParam)("/ajax/proxy/mmdb/approve/comment/" + e + ".json"), {
        ...
        var D = system.imgs, S = null, I = {};
        D && D.length && ((0, c.default)(function (t) {
            I = D.map(function (i) {
                return {src: t(n(i)), thumb: t(n(i, 160, 160))}
            })
        }), S = {
            dynamic: !0,
            thumbnail: !0,
            ...
            loop: !1,
            dynamicEl: I
        }), $(".album img").each(l), $(".tab-img ul img").each(l), e(1261)
    }, 1258: function (t, i, e) {
        "use strict";
        ...
        var o = function () {
            function t(i, e) {
                s(this, t), this.$elem = i, this.opts = $.extend({
                    triggerEvent: "click",
                    titleClass: "tab-title",
                    contentClass: "tab-content"
                }, e), this.$titleList = this.$elem.find("." + this.opts.titleClass), this.$contentList = this.$elem.find("." + this.opts.contentClass), this.bindEvents(), this.isLoading = !1
            }
            ...
            return t.prototype.bindEvents = function () {
                ...
                if (isNaN(t) || (s = t), -1 === s && (s = i.index(t)), -1 === s && (s = e.index(t)), ~s) {
        ...
        $.fn.tab = function (t) {
            return this.data("tab", new o(this, t)), this
        }
    }, 1259: function (t, i, e) {
        var s, o = e(123);
        s = o.currentEnv ? o.currentEnv : o.currentEnv = new o.Environment([], void 0);
        var n = (e(124)(s), o.webpackDependencies || (o.webpackDependencies = {}));
        n["../_ui/score-star.html"] = e(1260);
        var a = e(125);
        !function () {
            (o.nunjucksPrecompiled = o.nunjucksPrecompiled || {})["pages/movie/detail-comment.html"] = function () {
                function t(t, i, e, s, o) {
                    var n = null, a = null, r = "";
                    try {
                        var h = null;
                        t.getTemplate("../_ui/score-star.html", !1, "pages/movie/detail-comment.html", !1, function (l, d) {
                            if (l) return void o(l);
                            d.getExported(function (l, d) {
                                if (l) return void o(l);
        ...
        }(), t.exports = a(o, s, o.nunjucksPrecompiled["pages/movie/detail-comment.html"], n)
    }, 1260: function (t, i, e) {
        var s, o = e(123);
        s = o.currentEnv ? o.currentEnv : o.currentEnv = new o.Environment([], void 0);
        var n = (e(124)(s), o.webpackDependencies || (o.webpackDependencies = {})), a = e(125);
        !function () {
            (o.nunjucksPrecompiled = o.nunjucksPrecompiled || {})["pages/_ui/score-star.html"] = function () {
                function t(t, i, e, s, o) {
                    var n = null, a = null, r = "";
                    try {
        ...
        }(), t.exports = a(o, s, o.nunjucksPrecompiled["pages/_ui/score-star.html"], n)
    }, 1261: function (t, i) {
    }, 393: function (t, i) {
    }, 394: function (t, i) {/*! lightgallery - v1.2.21 - 2016-06-28
* http://sachinchoolur.github.io/lightGallery/
* Copyright (c) 2016 Sachin N; Licensed Apache 2.0 */
        !function (t, i, e, s) {
            "use strict";
            ...
            o.prototype.init = function () {
                ...
                var s = t.match(/\/\/(?:www\.)?youtu(?:\.be|be\.com)\/(?:watch\?v=|embed\/)?([a-z0-9\-\_\%]+)/i),
                    ...
                    n = t.match(/\/\/(?:www\.)?dai.ly\/([0-9a-z\-_]+)/i),
                ...
                var e, s, o = null;
                if (this.s.dynamic ? this.s.dynamicEl[i].subHtmlUrl ? e = this.s.dynamicEl[i].subHtmlUrl : o = this.s.dynamicEl[i].subHtml : (s = this.$items.eq(i), s.attr("data-sub-html-url") ? e = s.attr("data-sub-html-url") : (o = s.attr("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !o && (o = s.attr("title") || s.find("img").first().attr("alt")))), !e) if (void 0 !== o && null !== o) {
                    var n = o.substring(0, 1);
                    "." !== n && "#" !== n || (o = this.s.subHtmlSelectorRelative && !this.s.dynamic ? s.find(o).html() : t(o).html())
                } else o = "";
                ".lg-sub-html" === this.s.appendSubHtmlTo ? e ? this.$outer.find(this.s.appendSubHtmlTo).load(e) : this.$outer.find(this.s.appendSubHtmlTo).html(o) : e ? this.$slide.eq(i).load(e) : this.$slide.eq(i).append(o), void 0 !== o && null !== o && ("" === o ? this.$outer.find(this.s.appendSubHtmlTo).addClass("lg-empty-html") : this.$outer.find(this.s.appendSubHtmlTo).removeClass("lg-empty-html")), this.$el.trigger("onAfterAppendSubHtml.lg", [i])
                ...
                if (p.s.dynamic) {
                    if (p.s.dynamicEl[e].poster && (u = !0, r = p.s.dynamicEl[e].poster), d = p.s.dynamicEl[e].html, a = p.s.dynamicEl[e].src, p.s.dynamicEl[e].responsive) {
                        c(p.s.dynamicEl[e].responsive.split(","))
                    }
                    ...
                    if (p.$items.eq(e).attr("data-poster") && (u = !0, r = p.$items.eq(e).attr("data-poster")), d = p.$items.eq(e).attr("data-html"), a = p.$items.eq(e).attr("href") || p.$items.eq(e).attr("data-src"), p.$items.eq(e).attr("data-responsive")) {
                        c(p.$items.eq(e).attr("data-responsive").split(","))
                    }
                    h = p.$items.eq(e).attr("data-srcset"), l = p.$items.eq(e).attr("data-sizes")
                }
                var m = !1;
                p.s.dynamic ? p.s.dynamicEl[e].iframe && (m = !0) : "true" === p.$items.eq(e).attr("data-iframe") && (m = !0);
                var g = p.isVideo(a, e);
                if (!p.$slide.eq(e).hasClass("lg-loaded")) {
                    if (m) p.$slide.eq(e).prepend('<div class="lg-video-cont" style="max-width:' + p.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>'); else if (u) {
                        var f = "";
                        f = g && g.youtube ? "lg-has-youtube" : g && g.vimeo ? "lg-has-vimeo" : "lg-has-html5", p.$slide.eq(e).prepend('<div class="lg-video-cont ' + f + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + r + '" /></div></div>')
                    } else g ? (p.$slide.eq(e).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'), p.$el.trigger("hasVideo.lg", [e, a, d])) : p.$slide.eq(e).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + a + '" /></div>');
                ...
                }), g && g.html5 && !u && p.$slide.eq(e).addClass("lg-complete"), !0 === s && (p.$slide.eq(e).hasClass("lg-complete") ? p.preload(e) : p.$slide.eq(e).find(".lg-object").on("load.lg error.lg", function () {
                    p.preload(e)
                }))
                ...
                if (!n.lGalleryOn || o !== i) {
                    ...
                    if (!n.lgBusy) {
                        if (this.s.download) {
                            var d;
                            d = n.s.dynamic ? !1 !== n.s.dynamicEl[i].downloadUrl && (n.s.dynamicEl[i].downloadUrl || n.s.dynamicEl[i].src) : "false" !== n.$items.eq(i).attr("data-download-url") && (n.$items.eq(i).attr("data-download-url") || n.$items.eq(i).attr("href") || n.$items.eq(i).attr("data-src")), d ? (t("#lg-download").attr("href", d), n.$outer.removeClass("lg-hide-download")) : n.$outer.addClass("lg-hide-download")
                        }
