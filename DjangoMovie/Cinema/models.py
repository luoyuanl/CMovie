...
class Orders(models.Model):
    ...
    order_datetime = models.DateTimeField(auto_now_add=True) # 订单日期
    order_userphone = models.CharField(max_length=60,null=True) # 用户手机
    order_skdid = models.IntegerField(null=True) # 场次id
